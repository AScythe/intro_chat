...
| Workflow | 19 custom agentic pipeline skills |
...
| `.opencode/skills/` | 16 agentic workflow skill definitions | Yes |
...
The `.opencode/skills/` directory contains 19 skills implementing a Agentic Development pipeline (20 with the auto-generated `graphify` skill in `AGENTS.md`):
